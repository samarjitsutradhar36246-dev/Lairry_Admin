      ...
      <Routes>
        ...
        <Route element={<ProtectedAdminRoute />}>
          <Route path="/admin" element={<AdminLayout />}>
            ...
            <Route path="institute-location-map" element={<InstituteLocationMap />} />
            <Route path="growth-analytics-section" element={<GrowthAnalyticsSection />} />
            <Route path="financial-analytics" element={<FinancialSection />} />
            <Route path="financial-analytics/:id" element={<PaymentDetails/>} />
            <Route path="ai-model-intelligence" element={<AiIntelligenceSection />} />
            <Route path="students-management" element={<StudentsSection />} />
            <Route path="students-management/:id" element={<StudentProfile />} />
            <Route path="institutes-management" element={<InstitutesSection />} />
            <Route path="institutes-management/:id" element={<InstituteProfile />} />
