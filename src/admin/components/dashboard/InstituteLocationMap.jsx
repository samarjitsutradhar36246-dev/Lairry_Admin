  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      >
        ...
        {!isPreview && (
          <div
            className="relative flex gap-3 px-6 py-4 justify-end 
              bg-gray-50 dark:bg-slate-800/30 
              border-b border-gray-200 dark:border-slate-700/30 
              flex-wrap"
          >
            {/* Prev / Next buttons */}
            <button
            ...
            <button
              ...
              className={`group flex items-center gap-2 px-4 py-2 rounded-xl font-medium transition-all duration-200 ${
                showAll
                  ? "bg-gradient-to-r from-cyan-500 to-cyan-600 text-white hover:from-cyan-600 hover:to-cyan-700 shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40"
                  : "bg-white dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/50 text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700/50 hover:border-gray-300 dark:hover:border-slate-600/50 hover:text-gray-900 dark:hover:text-white cursor-pointer"
              }`}
            >
              <Layers size={16} />
        ...
        <div className={`relative ${isPreview ? "h-[400px]" : "h-[450px]"}`}>
          {loading ? (
            ...
            >
              ...
              />
              {/* Light mode overlay - subtle blue tint */}
              <div className="absolute inset-0 bg-blue-500/10 dark:bg-blue-900/30 pointer-events-none"></div>
        ...
        {!loading && (
          <div
            className="relative flex items-center justify-between px-6 py-3 
              bg-gray-50 dark:bg-slate-800/30 
              border-t border-gray-200 dark:border-slate-700/30"
          >
    ...
    bg-cyan-50 dark:bg-cyan-500/10 
    border border-cyan-200 dark:border-cyan-500/20 
    overflow-hidden max-w-xl ml-15"
                >
                  {/* Scrolling text */}
