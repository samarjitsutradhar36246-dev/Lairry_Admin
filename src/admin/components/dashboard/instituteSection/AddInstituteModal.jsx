...
// - Lat/Lng display block removed (LocationPicker now shows them internally, read-only)
// - "Map Location Picker" label + Globe icon block removed (LocationPicker is self-contained)
        ...
        <div className="relative overflow-y-auto flex-1 p-6">
          <div className="space-y-6">
            ...
            <div
              ...
              {/* PIN / Country / State / City / Street fields */}
              <SmartLocationFields
              ...
              {/* Map — auto-locates from address, no manual interaction */}
              <div id="tour-map-picker" className="mt-2">
                <LocationPicker
                  newInstitute={newInstitute}
                  setNewInstitute={setNewInstitute}
                />
              ...
              {/* NOTE: Lat/Lng display moved inside LocationPicker as read-only fields */}
            </div>
